...
const GROUPS: Array<{ title: string; items: Array<{ label: string; template: TemplateInsert }> }> = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "asinh", template: { text: "asinh()", cursorOffset: -1, wrapSelection: true } },
      { label: "acosh", template: { text: "acosh()", cursorOffset: -1, wrapSelection: true } },
      { label: "atanh", template: { text: "atanh()", cursorOffset: -1, wrapSelection: true } },
    ],
  },
];
