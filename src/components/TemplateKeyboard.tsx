...
const GROUPS: Array<{ title: string; items: Array<{ label: string; template: TemplateInsert; display?: ReactNode }> }> = [
  {
    title: "\u0411\u0430\u0437\u043e\u0432\u044b\u0435",
    items: [
      ...
      {
        label: "\u221a",
        template: unaryTemplate("sqrt"),
        display: (
          <span className="sqrt-key-symbol" aria-hidden="true">
            <span className="sqrt-key-radical">√</span>
            <span className="sqrt-key-overbar" />
          </span>
        ),
      },
